        ...
        <div id="home" className="container mx-auto px-3" >
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
                <div className="relative">
                    ...
                    <p className="text-[#F1F1F2]  text-sm xl:text-md leading-5 mt-5">MesseMatch ist die revolutionäre Auftragsbörse im Swoom Stil die talentierte Monteure mit Top-Auftraggebern im Bereich Messe und Veranstaltungsbau verbinden.
                        Swoomen, Matchen und Auftrag sichern!</p>

                    <div className="mt-8 space-y-2 md:space-y-0 md:flex md:items-center">
